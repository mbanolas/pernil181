...
<h3>Seleccionar Tickets para cambiar cliente y/o forma pago</h3>
<input type="hidden" id="ajax" value="mostrar/mostrarTicket">
...
$(document).ready(function () {
    ...
    $('#mostrarTickets').click(function(){
        ...
        $.ajax({
            url: "<?php echo base_url() ?>"+"index.php/mostrar/ajax",
            data: {'ticket': ticket},
            type: 'POST',
            ...
            error: function(){
                alert("Error. Informar Administrador")
            }
        });
         window.location.href = "<?php echo base_url() ?>"+"index.php/mostrar/mostrarTicket";
       // window.location.href = "<?php echo base_url() ?>"+"index.php/mostrar/mostrarTicketCambiar/"+ticket;
    })
    
    /*
    $('#mostrarTicketMostrar').click(function(e){
    ...
    */
    ...
    function buscarTickets(){
        ...
        var final=$('#final').val()
         ...
         $('#mostrarTicketMostrar').attr('disabled','disabled')
         
            $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>"+"index.php/mostrar/getTickets", 
