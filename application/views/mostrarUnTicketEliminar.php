...
<hr>
    ...
    <input type="hidden" id="ticketEliminar" value="<?php echo $ticket['numero'] ?>">
    <input type="hidden" id="fechaEliminar" value="<?php echo $ticket['fecha'] ?>">
...
$(document).ready(function(){
  ...
  $('#menuCopiaEliminarTicket').addClass('btn-primary');  
})
</script>
