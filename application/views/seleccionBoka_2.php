...
<h3>Seleccionar periodo Listado Datos Boka</h3>

<div class="row">
    <div class="col-xs-12 col-md-8">
         <?php echo form_open('listados/listaBoka',array('role'=>'form', 'class'=> 'fechas form-horizontal')) ; ?>
    ...
    <li>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">                <button id="listadoBoka" style="display: inline;" type="submit" class="btn btn-primary btn-mini" >
                    <span class="" aria-hidden="true"></span> Listado Datos Boka
                </button>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Reduzca el número con otra selección (máx 500).
            </div>
            <!-- dialog buttons -->
...
$(document).ready(function(){
    ...
    $('#listadoBoka').click(function(e){
        var tickets=parseInt($('#numTickets').html());
        if (tickets>500){
            e.preventDefault();
           $('#resultado').html(tickets)
            $("#myModal").modal({                   
      "backdrop"  : "static",
      "keyboard"  : true,
      "show"      : true                     
