...
//name the worksheet
$this->excel->getActiveSheet()->setTitle(substr("Traslado_y_destino", 0, 30));
// $this->excel->getActiveSheet()->setCellValue('A1', "Traslado y destino ");
...
$this->excel->getActiveSheet()->setCellValue('B13', "Barcelona, " . $dia . " de " . $mes . " " . substr($fecha, 6, 4));
$lineaCuerpo = 17;
$this->excel->getActiveSheet()->setCellValue("B$lineaCuerpo", "ATTN. ILUSTRISIMO SR. ADMINISTRADOR DE LA ADUANA DE BARCELONA");
$lineaCuerpo++;
$lineaCuerpo++;

$this->excel->getActiveSheet()->setCellValue("B$lineaCuerpo", "Certificamos que los $peso Kg. de mercancía, que se exportan con la factura $factura, ");
$lineaCuerpo++;
$this->excel->getActiveSheet()->setCellValue("B$lineaCuerpo", "no están recogidos en el Reglamento CE 1013/2006 de fecha 14 de Junio 2006 ");
$lineaCuerpo++;
$this->excel->getActiveSheet()->setCellValue("B$lineaCuerpo", "relativo a los traslados de residuos.");
$lineaCuerpo++;
$lineaCuerpo++;
$lineaCuerpo++;
...
*/
$filename = "Traslado_y_destino.xls";
