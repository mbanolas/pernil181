...
<div class="row">
  <div class="form-group col-xs-3">
    <button type="button" id="verFacturasProveedores" class="btn btn-default">Ver tabla Facturas Proveedores <img class="hide" src="<?php echo base_url() ?>images/ajax-loader-2.gif" width="20" height="20" alt="Loading"></button>
  </div>
</div>
<div class="row">
  <div class="form-group col-xs-3">
    <button type="button" id="nuevaFacturaProveedor" class="btn btn-default">Nueva Factura Proveedor <img class="hide" src="<?php echo base_url() ?>images/ajax-loader-2.gif" width="20" height="20" alt="Loading"></button>
  </div>
</div>
<!-- <div class="row"> 
  <div class="form-group col-xs-3">
...
<script>
  $(document).ready(function() {
    ...
    $('#verFacturasProveedores').click(function() {
      ...
      $("#verFacturasProveedores > img").removeClass('hide')
      var url = "<?php echo base_url() ?>index.php/gestionTablas/facturasProveedores/" + tipo + "/" + desde + "/" + hasta
      window.location.href = url;
    })

    $('#nuevaFacturaProveedor').click(function() {
      var url = "<?php echo base_url() ?>index.php/compras/facturaProveedor"
      window.location.href = url;
    })
