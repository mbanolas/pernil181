...
<h3>Seleccionar periodo Listado Productos Ventas</h3>
...
$(document).ready(function () {
            ...
            success: function(datos){
                ...
                var num1=valores['num1'];
                    if(num1>0) {
                        ...
                        if(parseInt(valores['ultimo1']['RASA'])-parseInt(valores['primero1']['RASA'])!=parseInt(num1)-  1){
                           ...
                           numeracion1+=' <br>Faltan '+valores['faltan1']
                ...
                if(num2>0) {
                        ...
                        if(parseInt(valores['ultimo2']['RASA'])-parseInt(valores['primero2']['RASA'])!=parseInt(num2)-  1){
                           ...
                           numeracion2+=' <br>Faltan '+valores['faltan2']
                ...
                if(num3>0) {
                        ...
                        if(parseInt(valores['ultimo3']['RASA'])-parseInt(valores['primero3']['RASA'])!=parseInt(num3)-  1){
                           ...
                           numeracion3+=' <br>Faltan '+valores['faltan3']
                 ...
                 $('#balanza1').html(num1); 
                  $('#balanza2').html(num2); 
                   ...
                   if(valores['faltan1'] || valores['faltan2'] || valores['faltan3']){
                       var resultado="";
                       if(valores['ticketsFaltan1']) resultado+='Bascula 1: '+valores['ticketsFaltan1']+'<br />';
                    if(valores['ticketsFaltan2']) resultado+='Bascula 2: '+valores['ticketsFaltan2']+'<br />';
                     if(valores['ticketsFaltan3']) resultado+='Bascula 3: '+valores['ticketsFaltan3']+'<br />';
    ...
    function rangoPeriodo(inicio,final){
        $('#listadoBoka').attr('disabled','disabled')
        $('#numTickets').html('-')
         $('#balanza1').html('-')
         $('#balanza2').html('-')
        ...
        if (difMeses>4){
            ...
            $('.modal-body#resultado').html('El periodo debe de ser de máximo 4 meses. Cambiar las fechas de inicio y/o final')
            $("#myModal").modal()
             return false;
        }
        return true;
    ...
    $('#inicio, #dia').change(function(e){
       ...
       $('#dia').val($(this).val());
        ...
        if(!rangoPeriodo(inicio,final))return;
