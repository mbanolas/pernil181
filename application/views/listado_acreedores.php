...
<button  style="display: inline;" type="submit" class="btn btn-default btn-mini nuevoProveedor" name="proveedores">
  <span class="" aria-hidden="true"></span> Nuevo Acreedor
</button>


</div>
<div class="col-xs-12 col-sm-8">
    <h4>Listado Acreedores</h4>
</div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar Acreedor</h4>
      </div>
...
<div class="modal " id="myModalNuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Nuevo Acreedor</h4>
      </div>
      <div class="modal-body">
          ...
          <form class="form-horizontal proveedorNuevo">
              <fieldset>
                  ...
                  <!-- Text input-->
                  <div class="form-group">
                      <label class="col-md-4 control-label" for="id_codigo">Código Acreedor</label>  
                      <div class="col-md-4">
                          <input id="linea" type="hidden" name="linea" value="" />
...
<div class="modal " id="myModalEliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Eliminar Acreedor</h4>
      </div>
      <div class="modal-body">
          ...
          <form class="form-horizontal proveedorEliminar">
              <fieldset>
                  ...
                  <!-- Text input-->
                  <div class="form-group">
                      <label class="col-md-4 control-label titulo" for="nombre">Nombre Acreedor </label>  
                      <div class="col-md-6">
                  ...
                  <div class="form-group">
                      <label class="col-md-4 control-label" for="guardar"></label>
                      <div class="col-md-8">
                        <button id="guardarEliminar" name="guardar" class="btn btn-danger">Eliminar Acreedor</button>
                        <button type="button" class="btn btn-default " data-dismiss="modal" aria-label="Cerrar">Cancelar</button>
                      </div>
                  </div>
...
$(document).ready(function(){
  ...
  $('#menuListaAcreedores').addClass('btn-primary');    
})
</script>
...
$(document).ready(function () {
   ...
   $("button#guardar").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>"+"index.php/process/acreedor", //process para grabar
    ...
    $("button#guardarNuevo").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>"+"index.php/process/acreedorNuevo", //process para grabar
            data: $('form.proveedorNuevo').serialize(),
            success: function(datos){
                //alert(datos);
                var obj = $.parseJSON(datos);
                if (obj.salida==false){
                    $('.modalError').text("Acreedor con código y/o nombre YA existente o falta algún campo");
                }
                else {
    ...
    $("button#guardarEliminar").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>"+"index.php/process/acreedorEliminar", //process para grabar
