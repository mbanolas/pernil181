...
<h3>Seleccionar periodo Listado Importes Ventas</h3>

<div class="row">
    <div class="col-xs-12 col-md-8">
         <?php echo form_open('listados/resumenBoka',array('role'=>'form', 'class'=> 'fechas form-horizontal')) ; ?>
    ...
    <li>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">                <button id="listadoBoka" style="display: inline;" type="submit" class="btn btn-primary btn-mini" >
                    <span class="" aria-hidden="true"></span> Listado Importes Ventas
                </button>
            </div>
        </div>
