...
<h3>Seleccionar Tickets para mostrar</h3>
...
$(document).ready(function () {
    ...
    $('#mostrarTickets').click(function(){
        ...
        window.location.href = "<?php echo base_url() ?>"+"index.php/mostrar/mostrarTicketMostrar/"+ticket;
    })
         ...
         $('#mostrarTicketMostrar').attr('disabled','disabled')
            ...
            success: function(datos){
               ...
               if(valores['num']==0) {
                  ...
                  alerta("Información","No se ha seleccionado periodo o no existe ningún ticket en el periodo");
